...
export default {
  ...
  editor: {
    ...
    messages: {
      ...
      factCheckError: "তথ্য যাচাই করতে ব্যর্থ। অনুগ্রহ করে পরে আবার চেষ্টা করুন।",
      factCheckServiceError: "আমাদের তথ্য-যাচাই পরিষেবা বর্তমানে অনুপলব্ধ। কয়েক মিনিট পর আবার চেষ্টা করুন।",
      factCheckNetworkError: "তথ্য-যাচাই করার সময় নেটওয়ার্ক ত্রুটি। আপনার সংযোগ পরীক্ষা করে আবার চেষ্টা করুন।",
